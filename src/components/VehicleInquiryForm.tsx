    ...
    <section id="consulta" className="py-20 bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <Car className="h-12 w-12 text-[#2E7D32] mx-auto mb-4" />
        ...
        >
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[#2E7D32] text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-[#1B5E20] transition transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
          >
