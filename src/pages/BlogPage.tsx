        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#2E7D32] focus:border-transparent"
            />
          </div>
        </div>
      </section>
              ...
              {selectedPost ? (
                <article className="max-w-3xl mx-auto">
                  <button
                    ...
                    className="text-[#2E7D32] font-semibold hover:underline mb-6 flex items-center"
                  >
                  ...
                  <div className="bg-white rounded-xl shadow-lg p-8">
                    ...
                    <h1 className="text-4xl font-bold text-[#2E7D32] mb-6">
                      {selectedPost.title}
                    </h1>
                  ...
                  <div className="mt-12">
                    <h3 className="text-2xl font-bold text-[#2E7D32] mb-6">Outros artigos</h3>
                      ...
                      {posts
                        ...
                        .map((post) => (
                          ...
                          >
                            ...
                            <div className="p-4">
                              <h4 className="font-bold text-[#2E7D32]">{post.title}</h4>
                  ...
                  {filteredPosts.map((post) => (
                    ...
                    >
                      ...
                      <div className="p-6">
                        ...
                        <button className="text-[#2E7D32] font-semibold flex items-center hover:underline">
                          Ler mais
